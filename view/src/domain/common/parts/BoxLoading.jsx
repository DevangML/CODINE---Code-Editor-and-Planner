...
import { shadow, animate } from '../styles/partStyles/animate';
import { commonStyle, sizeContainer } from '../styles/partStyles/loaderCommon.js';
...
const LoadContainer = styled.div`
  ...
  &:before {
    ...
    opacity: 0.1;
    position: absolute;
    top: calc(${(props) => sizeContainer[props.size] || sizeContainer['default']} + 5px);
    left: 0;
    border-radius: 50%;
...
const BoxLoading = ({ style = commonStyle, color, speed, size = 'default' }) => {
  return <LoadContainer style={style} color={color} speed={speed} size={size}></LoadContainer>;
};
