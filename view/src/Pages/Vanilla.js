...
export class Vanilla extends Component {
  ...
  syncUpdates = () => {
    ...
    axios
      .post("http://localhost:5000/vanilla", data)
      .catch(console.error);
  };
      ...
      <section className="vanilla">
        ...
        <main className="vanilla__main">
          <section className="vanilla__main__section-1">
            ...
            <section className="vanilla__main__section-1__sub-section-2">
            ...
            <section className="vanilla__main__section-1__sub-section-3">
          ...
          <section className="vanilla__main__section-2">
            <iframe className='vanilla__main__section-2__item' ref={this.iRef}></iframe>
          </section>
        </main>
        <Dfooter />
      </section>
